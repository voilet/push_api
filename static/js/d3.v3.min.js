!function () {
  ...
  function ct(n, t, e) {
    ...
    r = lt(r) * Ha,
    i = lt(i) * Fa,
    new gt(ht(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), ht( - 0.969266 * u + 1.8760108 * r + 0.041556 * i), ht(0.0556434 * u - 0.2040259 * r + 1.0572252 * i))
  }
  function st(n, t, e) {
  ...
  function Ct() {
    var n = Date.now();
    for (Ba = Za; Ba; ) n >= Ba.t && (Ba.f = Ba.c(n - Ba.t)),
    Ba = Ba.n;
    return n
  }
  function Nt() {
  ...
  function Tt(n) {
    ...
    i = r ? function (n) {
      ...
      ], i = 0, o = r[0]; t > 0 && o > 0; ) u.push(n.substring(t -= o, t + o)),
      o = r[i = (i + 1) % r.length];
...
function Ut(n) {
  function t(n) {
    function t(t) {
      for (var e, u, i, o = [
      ], a = - 1, c = 0; ++a < r; ) 37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = ec[e = n.charAt(++a)]) && (e = n.charAt(++a)), (i = C[e]) && (e = i(t, null == u ? 'e' === e ? ' ' : '0' : u)), o.push(e), c = a + 1);
  ...
  var C = {
    ...
    Y: function (n, t) {
      return jt(n.getFullYear() % 10000, t, 4)
    },
    Z: te,
    '%': function () {
      return '%'
  ...
  return function (u, i) {
    ...
    y = {
      ...
      polygonEnd: function () {
        ...
        g = Zo.merge(g);
        var n = Le(m, p);
        g.length ? (_ || (i.polygonStart(), _ = !0), Se(g, ze, n, e, i))  : n && (_ || (i.polygonStart(), _ = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
        _ && (i.polygonEnd(), _ = !1),
        g = p = null
      },
      sphere: function () {
...
function Te(n) {
  ...
  return {
    ...
    point: function (i, o) {
      var a = i > 0 ? ba : - ba,
      c = ua(i - e);
      ua(c - ba) < ka ? (n.point(e, r = (r + o) / 2 > 0 ? Sa : - Sa), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(i, r), t = 0)  : u !== a && c >= ba && (ua(e - u) < ka && (e -= u * ka), ua(i - a) < ka && (i -= a * ka), r = qe(e, r, i, o), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), t = 0),
      n.point(e = i, r = o),
      u = a
    },
    lineEnd: function () {
  ...
  function e(n) {
    ...
    return {
      ...
      point: function (f, h) {
        ...
        if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (me(e, g) || me(p, g)) && (p[0] += ka, p[1] += ka, v = t(p[0], p[1]))), v !== c) l = 0,
  ...
  return function (a) {
    ...
    N = {
      ...
      polygonEnd: function () {
        ...
        e = k && t,
        u = v.length;
        (e || u) && (a.polygonStart(), e && (a.lineStart(), s(null, null, 1, a), a.lineEnd()), u && Se(v, i, t, s, a), a.polygonEnd()),
        v = d = m = null
      }
    };
    return N
...
function Je(n) {
  ...
  function u(t, e, r, a, c, s, l, f, h, g, p, v, d, m) {
    ...
    if (M > 4 * i && d--) {
      ...
      L = N - e,
      T = x * z - y * L;
      (T * T / M > i || ua((y * z + x * L) / M - 0.5) > 0.3 || o > a * g + c * p + s * v) && (u(t, e, r, a, c, s, C, N, E, _ /= S, b /= S, w, d, m), m.point(C, N), u(C, N, E, _, b, w, l, f, h, g, p, v, d, m))
    }
  }
  var i = 0.5,
  o = Math.cos(30 * Aa),
...
function sr(n, t) {
  ...
  return function (u, i, o, a) {
    var c = o * t;
    null != u ? (u = lr(e, u), i = lr(e, i), (o > 0 ? i > u : u > i) && (u += o * wa))  : (u = n + o * wa, i = n - 0.5 * c);
    for (var s, l = u; o > 0 ? l > i : i > l; l -= c) a.point((s = de([e,
    - r * Math.cos(l),
    - r * Math.sin(l)])) [0], s[1])
  }
}
...
function br(n, t) {
  return [Math.log(Math.tan(ba / 4 + t / 2)),
  - n]
}
function wr(n) {
  return n[0]
...
function Rr(n) {
  for (var t, e, r, u, i = n.x, o = n.y, a = Vc._; a; ) if (r = Dr(a, o) - i, r > ka) a = a.L;
   else {
    if (u = i - Pr(a, o), !(u > ka)) {
  ...
  if (Vc.insert(t, c), t || e) {
    ...
    Or(e),
    void 0;
    if (!e) return c.edge = Xr(t.site, c.site),
    void 0;
    Yr(t),
    Yr(e);
    var s = t.site,
...
function jr(n) {
  for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Zc, d = v.length; d--; ) if (i = v[d], i && i.prepare()) for (a = i.edges, c = a.length, o = 0; c > o; ) l = a[o].end(),
  r = l.x,
  u = l.y,
  s = a[++o % c].start(),
  t = s.x,
...
function Ir(n) {
  ...
  (!Zr(t, n) || !r(t) || ua(t.a.x - t.b.x) < ka && ua(t.a.y - t.b.y) < ka) && (t.a = t.b = null, e.splice(u, 1))
}
function Zr(n, t) {
  var e = n.b;
  if (e) return !0;
...
function tu(n, t) {
  ...
  i = n.sort(eu).pop();
  for (Ic = [
  ], Zc = new Array(n.length), Vc = new Jr, $c = new Jr; ; ) if (u = Xc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== e || i.y !== r) && (Zc[i.i] = new Ur(i), Rr(i), e = i.x, r = i.y),
  i = n.pop();
   else {
    if (!u) break;
    qr(u.arc)
...
function fu(n, t) {
  ...
  for (n += '', t += ''; (e = Gc.exec(n)) && (r = Kc.exec(t)); ) (u = r.index) > i && (u = t.substring(i, u), a[o] ? a[o] += u : a[++o] = u),
...
function Su(n, t) {
  ...
  arguments.length ? e = t / wa * Math.asin(1 / n)  : (n = 1, e = t / 4),
  function (r) {
...
function ju(n) {
  for (var t = n.source, e = n.target, r = Fu(t, e), u = [
    t
  ]; t !== r; ) t = t.parent,
  u.push(t);
...
function ro(n) {
  function t(t) {
    ...
    ], f = - 1, h = t.length, g = bt(e), p = bt(r); ++f < h; ) u.call(this, c = t[f], f) ? l.push([ + g.call(this, c, f),
...
function lo(n, t) {
  return n.length < 3 ? uo(n)  : n[0] + ho((n.push(n[0]), n), go([n[n.length - 2]].concat(n, [
    n[1]
  ]), t))
}
function fo(n, t) {
...
function vo(n) {
  ...
  i.push(t[0]),
  o.push(t[1]);
  for (e.push(xo(bs, i) + ',' + xo(bs, o)), --r; ++r < u; ) t = n[r],
  i.shift(),
  i.push(t[0]),
  o.shift(),
  o.push(t[1]),
...
function bo(n) {
  ...
  ], u = n[0], i = n[1], o = r[0] = _o(u, i); ++t < e; ) r[t] = (o + (o = _o(u = i, i = n[t + 1]))) / 2;
  return r[t] = o,
  r
}
function wo(n) {
  for (var t, e, r, u, i = [
  ], o = bo(n), a = - 1, c = n.length - 1; ++a < c; ) t = _o(n[a], n[a + 1]),
  ua(t) < ka ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
...
function Eo(n) {
  function t(t) {
    ...
    ], y = - 1, x = t.length, M = bt(e), _ = bt(u), b = e === r ? function () {
      return g
    }
     : bt(r), w = u === i ? function () {
      return p
    }
     : bt(i); ++y < x; ) o.call(this, h = t[y], y) ? (d.push([g = + M.call(this, h, y),
...
Zo.mean = function (n, e) {
  ...
  o = - 1,
  a = i;
  if (1 === arguments.length) for (; ++o < i; ) t(r = n[o]) ? u += r : --a;
...
}, fa = Sizzle, ga = Sizzle.matchesSelector),
...
pa.data = function (n, t) {
  function e(n, e) {
    ...
    if (t) {
      ...
      (u = m.get(d)) ? (g[r] = u, u.__data__ = i)  : y.has(d) || (p[r] = q(i)),
      y.set(d, i),
      m.remove(d);
...
Zo.behavior.zoom = function () {
  ...
  function f() {
    ...
    d ? clearTimeout(d)  : (g = t(p = v || Zo.mouse(this)), H.call(this), o(n)),
  ...
  return n.event = function (n) {
    n.each(function () {
      ...
      Ss ? Zo.select(this).transition().each('start.zoom', function () {
        ...
        u = e / 2,
        i = r / 2,
        o = Zo.interpolateZoom([(u - S.x) / S.k,
        (i - S.y) / S.k,
        e / S.k], [
          (u - t.x) / t.k,
          (i - t.y) / t.k,
  ...
  n.scaleExtent = function (t) {
    return arguments.length ? (E = null == t ? qa : [
      + t[0],
      + t[1]
    ], n)  : E
  },
...
Zo.formatPrefix = function (n, t) {
  var e = 0;
  return n && (0 > n && (n *= - 1), t && (n = Zo.round(n, zt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max( - 24, Math.min(24, 3 * Math.floor((e - 1) / 3)))),
  Ja[8 + e / 3]
};
var Ga = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
Ka = Zo.map({
...
Zo.geo.bounds = function () {
  ...
  _ = {
    ...
    polygonEnd: function () {
      ...
      _.lineStart = e,
      _.lineEnd = r,
      0 > lc ? (l = - (h = 180), f = - (g = 90))  : y > ka ? g = 90 : - ka > y && (f = - 90),
      M[0] = l,
      M[1] = h
    }
  };
...
Zo.geo.albers = function () {
  return Zo.geo.conicEqualArea().rotate([96,
  0]).center([ - 0.6,
  38.7]).parallels([29.5,
  45.5]).scale(1070)
},
Zo.geo.albersUsa = function () {
  ...
  u,
  i = Zo.geo.albers(),
  o = Zo.geo.conicEqualArea().rotate([154,
  0]).center([ - 2,
  58.5]).parallels([55,
  65]),
  a = Zo.geo.conicEqualArea().rotate([157,
  0]).center([ - 3,
  19.9]).parallels([8,
  18]),
  c = {
  ...
  n.translate = function (t) {
    ...
    l = + t[0],
    f = + t[1];
    return e = i.translate(t).clipExtent([[l - 0.455 * s,
    f - 0.238 * s],
    [
      l + 0.455 * s,
      f + 0.238 * s
    ]]).stream(c).point,
    r = o.translate([l - 0.307 * s,
    f + 0.201 * s]).clipExtent([[l - 0.425 * s + ka,
    f + 0.12 * s + ka],
    [
      l - 0.214 * s - ka,
      f + 0.234 * s - ka
    ...
    f + 0.212 * s]).clipExtent([[l - 0.214 * s + ka,
    f + 0.166 * s + ka],
    [
      l - 0.115 * s - ka,
      f + 0.234 * s - ka
...
Zo.geo.path = function () {
  function n(n) {
    return n && ('function' == typeof a && i.pointRadius( + a.apply(this, arguments)), o && o.valid || (o = u(i)), Zo.geo.stream(n, o)),
    i.result()
  }
  function t() {
    return o = null,
...
Zo.geom.hull = function (n) {
  function t(n) {
    ...
    + i.call(this, n[t], t),
    t]);
    for (a.sort(Er), t = 0; o > t; t++) c.push([a[t][0],
    - a[t][1]]);
    var s = kr(a),
    l = kr(c),
    f = l[0] === s[0],
...
Jr.prototype = {
  insert: function (n, t) {
    ...
    e === r.L ? (u = r.R, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r)  : (n === e.R && (Kr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, Qr(this, r)))  : (u = r.L, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r)  : (n === e.L && (Qr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, Kr(this, r))),
    e = n.U;
    this._.C = !1
  },
  remove: function (n) {
      ...
      do {
        ...
        if (n === u.L) {
          if (t = u.R, t.C && (t.C = !1, u.C = !0, Kr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
            t.R && t.R.C || (t.L.C = !1, t.C = !0, Qr(this, t), t = u.R),
            t.C = u.C,
            u.C = t.R.C = !1,
            Kr(this, u),
            n = this._;
          ...
          t.L && t.L.C || (t.R.C = !1, t.C = !0, Kr(this, t), t = u.L),
          t.C = u.C,
          u.C = t.L.C = !1,
          Qr(this, u),
          n = this._;
...
Zo.geom.voronoi = function (n) {
  ...
  return n ? t(n)  : (t.links = function (n) {
    ...
    return tu(e(n)).cells.forEach(function (e, r) {
      ...
      l = a[c].edge,
      f = l.l === o ? l.r : l.l,
      r < i.i && r < f.i && ru(o, i, f) < 0 && t.push([n[r],
      n[i.i],
      n[f.i]])
    }),
    t
  ...
  function i(n) {
    function i(n, t, e, r, u, i, o, a) {
      if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
        var c = n.x,
        l = n.y;
        if (null != c) if (ua(c - e) + ua(l - r) < 0.01) s(n, t, e, r, u, i, o, a);
         else {
          var f = n.point;
...
Zo.layout.bundle = function () {
  return function (n) {
    for (var t = [
    ], e = - 1, r = n.length; ++e < r; ) t.push(ju(n[e]));
    return t
  }
},
...
Zo.layout.force = function () {
  ...
  a.drag = function () {
    ...
    arguments.length ? (this.on('mouseover.force', Iu).on('mouseout.force', Zu).call(e), void 0)  : e
  },
  Zo.rebind(a, c, 'on')
};
var rs = 20,
...
Zo.layout.histogram = function () {
  function n(n, i) {
    for (var o, a, c = [
    ], s = n.map(e, this), l = r.call(this, s, i), f = u.call(this, l, s, i), i = - 1, h = s.length, g = f.length - 1, p = t ? 1 : 1 / h; ++i < g; ) o = c[i] = [
    ],
    o.dx = f[i + 1] - (o.x = f[i]),
    o.y = 0;
    if (g > 0) for (i = - 1; ++i < h; ) a = s[i],
    a >= l[0] && a <= l[1] && (o = c[Zo.bisect(f, a, 1, g) - 1], o.y += p, o.push(n[i]));
    return c
  }
  var t = !0,
  e = Number,
...
Zo.layout.tree = function () {
  ...
  function u(n, t, e) {
    if (t) {
      for (var r, u = n, i = n, o = t, c = u.parent.children[0], s = u.m, l = i.m, f = o.m, h = c.m; o = _i(o), u = Mi(u), o && u; ) c = Mi(c),
      i = _i(i),
      i.a = n,
...
Zo.layout.treemap = function () {
  ...
  i.padding = function (n) {
    function t(t) {
      ...
      return null == e ? Ni(t)  : zi(t, 'number' == typeof e ? [
        e,
        e,
        e,
        e
...
Zo.scale.log = function () {
  return Vi(Zo.scale.linear().domain([0,
  1]), 10, !0, [
    1,
    10
  ])
...
Cs.selectAll = function (n) {
  ...
  for (var c = - 1, s = this.length; ++c < s; ) for (var l = this[c], f = - 1, h = l.length; ++f < h; ) if (r = l[f]) {
    ...
    for (var g = - 1, p = e.length; ++g < p; ) (u = e[g]) && Po(u, g, o, i),
    t.push(u)
  }
  return qo(a, o)
},
...
Cs.transition = function () {
  for (var n, t, e, r, u = this.id, i = ++Ns, o = [
  ], a = 0, c = this.length; c > a; a++) {
    o.push(n = [
    ]);
    for (var t = this[a], s = 0, l = t.length; l > s; s++) (e = t[s]) && (r = Object.create(e.__transition__[u]), r.delay += r.duration, Po(e, s, i, r)),
    n.push(e)
  }
  return qo(o, i)
},
...
function u() {
  ...
  if (Zo.event.changedTouches ? L.on('touchmove.brush', v).on('touchend.brush', m)  : L.on('mousemove.brush', v).on('mouseup.brush', m), S.interrupt().selectAll('*').interrupt(), C) z[0] = l[0] - z[0],
  z[1] = f[0] - z[1];
   else if (k) {
    var T = + /w$/.test(k),
    q = + /^n/.test(k);
...
return new nc(1000 * Math.floor(n / 1000))
}, function (n, t) {
...
return new nc(60000 * Math.floor(n / 60000))
}, function (n, t) {
...
return new nc(3600000 * (Math.floor(n / 3600000 - t) + t))
}, function (n, t) {
