...
(function(window) {
    ...
    */
    ...
    var settings = {
        ...
        // Websocket settings
        wsHost: "ws://127.0.0.1:8888/websocket",
    ...
    function start(loc, psk) {
        ...
        webSocket.onclose = function() {
            ...
            d3.select("#events-data").selectAll("tr.row").remove(); 
            d3.select("#events-data").append("tr").attr('class', 'row').html("<td colspan='7'><img src='/static/images/loading.gif' style='margin-top: 6px;'/>&nbsp;<span style='display: inline-block; height: 25px; vertical-align: middle;'>Loading...</span></td>");
